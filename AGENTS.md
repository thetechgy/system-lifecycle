...
**Create dedicated feature branches from `main`. Never commit directly to `main`.**
...
Open a PR to `main`. Use regular merge commits unless the PR explicitly calls for a different strategy.
